...
CREATE TABLE JOURNEY (
  ...
  CUSTOMER_ID INT NOT NULL, -- CUSTOMER_ID
  DESTINATION VARCHAR(60) ,
...
INSERT INTO JOURNEY (CUSTOMER_ID, DESTINATION, DISTANCE, DRIVER_ID, DATE, TIME, DEMANDS_ID) VALUES
  (1, 'King''s Cross Station, London', 5, 2, '2015-10-14', '09:30:00', 1),
  (7, 'Heathrow Terminal 3, London', 20, 2, '2015-10-14', '12:00:00', 3),
  (7, '120 Green Lanes, London, N13', 7, 1, '2015-10-15', '06:00:00', 4),
  (7, '131 Stoke Newington High Road, London, N12', 8, 1, '2015-10-15', '12:00:00', 5),
  (1, 'Luton Airport, Luton', 30, 3, '2015-10-22', '10:00:00', 2);
